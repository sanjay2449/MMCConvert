...
const contactHandlerMulti = (req, res) => {
  uploadedData = [];
...
const contactConvertMulti = (req, res) => {
  if (uploadedData.length === 0) {
...
const contactDownloadMulti = (req, res) => {
...
export { contactHandlerMulti, contactConvertMulti, contactDownloadMulti };
