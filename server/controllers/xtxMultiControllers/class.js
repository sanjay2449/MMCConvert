...
const classHandlerMulti = (req, res) => {
  uploadedData = [];
...
const classConvertMulti = (req, res) => {
  if (uploadedData.length === 0) {
...
const classDownloadMulti = (req, res) => {
...
export { classHandlerMulti, classConvertMulti, classDownloadMulti };
