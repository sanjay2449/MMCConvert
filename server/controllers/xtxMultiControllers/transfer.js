...
// Upload Handler
const transferHandlerMulti = (req, res) => {
  uploadedData = [];
...
// Convert Handler
const transferConvertMulti = (req, res) => {
...
// Download Handler
const transferDownloadMulti = (req, res) => {
...
export {
  transferHandlerMulti,
  transferConvertMulti,
  transferDownloadMulti
};
