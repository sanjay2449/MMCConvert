...
const paidbillcreditHandlerMulti = (req, res) => {
  uploadedData2 = [];
...
const paidbillcreditConvertMulti = (req, res) => {
...
const paidbillcreditDownloadMulti = (req, res) => {
...
export {
  paidbillcreditHandlerMulti,
  paidbillcreditConvertMulti,
  paidbillcreditDownloadMulti
};
