...
const authcreditnoteHandler = (req, res) => {
  uploadedData2 = [];
...
const authcreditnoteConvert = (req, res) => {
...
const authcreditnoteDownload = (req, res) => {
...
export {
  authcreditnoteHandler,
  authcreditnoteConvert,
  authcreditnoteDownload,
};