...
// Upload Handler
const paidcreditnoteHandler = (req, res) => {
  uploadedData2 = [];
...
// Convert Handler
const paidcreditnoteConvert = (req, res) => {
...
// Download Handler
const paidcreditnoteDownload = (req, res) => {
...
export {
  paidcreditnoteHandler,
  paidcreditnoteConvert,
  paidcreditnoteDownload,
};
