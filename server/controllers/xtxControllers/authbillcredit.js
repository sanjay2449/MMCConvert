...
// Handler
const authbillcreditHandler = (req, res) => {
  uploadedData2 = [];
...
// Convert
const authbillcreditConvert = (req, res) => {
...
// Download
const authbillcreditDownload = (req, res) => {
...
export {
  authbillcreditHandler,
  authbillcreditConvert,
  authbillcreditDownload,
};