...
// const convertTracking = async () => {
//   if (!fs.existsSync(uploadedTrackingFilePath)) {
...
//     trackingType = trackingType.charAt(0).toUpperCase() + trackingType.slice(1); // Capitalize the first letter
...
//   const fileName = 'converted_tracking_category.csv';
//   const outputPath = path.join(outputDir, fileName);
//   fs.writeFileSync(outputPath, csvOutput);

//   return { message: 'Tracking data converted successfully.', downloadLink: `/download-tracking-category/${fileName}` };
// };
...
// module.exports = { uploadTracking, convertTracking, downloadTracking };
